...
# >>> variables 
# 
url_results = BASE_URL + "/" + BASE_BASKETBALL_URL + "/" + BASE_LEAGUES_LIST["SOUTH KOREA: KBL"] + "/" + BASE_RESULTS_URL 
url_standings = BASE_URL + "/" + BASE_BASKETBALL_URL + "/" + BASE_LEAGUES_LIST["SOUTH KOREA: KBL"] + "/" + BASE_STANDINGS_URL 
